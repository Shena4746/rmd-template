...
Serve and Open Book タスクを実行すると, プレビューしながらソースファイルの編集ができる.
...
- Open Book in Chrome : ビルドされた book_filename.html を見つけて Chrome で開く. book_filename は _bookdown.yml を読み込んで自動的に取得される.
